...
@app.route('/favorito/<id>',methods=['GET'])
def get_producto(id):
    producto=favoritos.query.get(id)
    return producto_schema.jsonify(producto)

@app.route('/favorito/<id>',methods=['DELETE'])
...
@app.route('/favorito', methods=['POST']) # crea ruta o endpoint
def create_producto():
...
@app.route('/favorito/<id>' ,methods=['PUT'])
